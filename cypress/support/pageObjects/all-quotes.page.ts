...
export default class AllQuotesPage {
  ...
  static readonly likeQuoteButton = "[data-test='quote-tile--like-quote-button']"
  static readonly unlikeQuoteButton = "[data-test='quote-tile--unlike-quote-button']"
  ...
  static assertQuoteWithTextAndAuthorIsVisible(quoteText: string, authorUsername: string) {
    cy.contains(this.quoteTile, quoteText).contains(authorUsername).should('be.visible')
  }

  static setInStoreTextOfQuoteNotCreatedOrLikedByUser(storeKey: string, username: string) {
  ...
  static assertUnlikeQuoteButtonIsVisibleOnQuoteTileWithText(quoteText: string) {
    cy.contains(this.quoteTile, quoteText).find(this.unlikeQuoteButton).should('be.visible')
  }
