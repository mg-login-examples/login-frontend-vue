export default class LoginPage {
  ...
  static readonly loginUserPasswordInput = "[data-test='login--user-password-input']"
  static readonly loginSubmitButton = "[data-test='login--submit-button']"
  static readonly loginRememberMeCheckbox = "[data-test='login--remember-me-checkbox']"
  static readonly loginShowPasswordButton = "[data-test='login--show-password-button']"
  static readonly loginShowPasswordButtonIcon = "[data-test='login--show-password-button'] svg"
  ...
  static clickOnRememberMeCheckbox() {
    cy.get(this.loginRememberMeCheckbox).should('not.be.checked').click().should('be.checked')
  }
  ...
  static assertPasswordInputIsOfTypePassword() {
    ...
    cy.get(this.loginShowPasswordButtonIcon).should('have.attr', 'data-icon', 'eye')
  }

  static assertPasswordInputIsOfTypeText() {
    cy.get(this.loginUserPasswordInput).should('have.attr', 'type', 'text')
    cy.get(this.loginShowPasswordButtonIcon).should('have.attr', 'data-icon', 'eye-slash')
  }
}
