export default class MyQuotesPage {
  ...
  static readonly editQuoteButton = "[data-test='quote-tile--edit-quote-button']"
  static readonly deleteQuoteButton = "[data-test='quote-tile--delete-quote-button']"
  ...
  static assertDeleteQuoteButtonIsVisibleOnQuoteTileWithText(quoteText: string) {
