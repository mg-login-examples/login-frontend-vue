...
export class InteractiveWebElement {
  ...
  async fill(text: string) {
    const stepTitle = this.userStepTitle(`enter text '${text}' in ${this.name}`)
    await test.step(stepTitle, async () => {
  ...
  async expectToExist() {
    ...
    await test.step(stepTitle, async () => {
      await expect(
        ...
        this.userStepTitle(`${this.name} should exist! Selector = ${this.selector}`)
      ).toBeGreaterThan(0)
    })
  }
  ...
  async expectToNotExist() {
    ...
    await test.step(stepTitle, async () => {
      await expect(
        this.page.locator(this.selector).count(),
        this.userStepTitle(`${this.name} should not exist! Selector = ${this.selector}`)
      ).toBe(0)
    })
  }
  ...
  async expectToBeVisible() {
    ...
    await test.step(stepTitle, async () => {
      await expect(
        ...
        this.userStepTitle(`${this.name} should be visible! Selector = ${this.selector}`)
      ).toBeVisible()
    })
  }
  ...
  async expectToBeHidden() {
    ...
    await test.step(stepTitle, async () => {
      await expect(
        this.page.locator(this.selector),
        this.userStepTitle(`${this.name} should be hidden! Selector = ${this.selector}`)
      ).toBeHidden()
    })
  }
  ...
  async expectToHaveText(text: string) {
    const stepTitle = this.userStepTitle(`expect ${this.name} to have text '${text}'`)
    await test.step(stepTitle, async () => {
      await expect(
        this.page.locator(this.selector),
        this.userStepTitle(`${this.name} should have text '${text}'! Selector = ${this.selector}`)
      ).toHaveText(text)
    })
  }
  async expectToContainText(text: string) {
    const stepTitle = this.userStepTitle(`expect ${this.name} to contain text '${text}'`)
    await test.step(stepTitle, async () => {
      await expect(
        this.page.locator(this.selector),
        this.userStepTitle(
  ...
  async expectToHaveValue(value: string) {
    const stepTitle = this.userStepTitle(`expect ${this.name} to have value ${value}`)
    await test.step(stepTitle, async () => {
      await expect(
        this.page.locator(this.selector),
        this.userStepTitle(
  ...
  async expectToBeEnabled() {
    ...
    await test.step(stepTitle, async () => {
      await expect(
        this.page.locator(this.selector),
        this.userStepTitle(`${this.name} should be enabled! Selector = ${this.selector}`)
      ).toBeEnabled()
    })
  }
  async expectToBeDisabled() {
    ...
    await test.step(stepTitle, async () => {
      await expect(
        this.page.locator(this.selector),
        this.userStepTitle(`${this.name} should be disabled! Selector = ${this.selector}`)
      ).toBeEnabled()
    })
  }
  async expectToBeFocused() {
    ...
    await test.step(stepTitle, async () => {
      await expect(
        this.page.locator(this.selector),
        this.userStepTitle(`${this.name} should be focused! Selector = ${this.selector}`)
      ).toBeFocused()
    })
  }
  async expectToBeChecked() {
    ...
    await test.step(stepTitle, async () => {
      await expect(
        this.page.locator(this.selector),
        this.userStepTitle(`${this.name} should be checked! Selector = ${this.selector}`)
      ).toBeChecked()
    })
  }
