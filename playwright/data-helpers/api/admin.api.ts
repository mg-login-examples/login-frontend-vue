...
export default class AdminAPI {
  ...
  static admin_api_login_user = process.env
    .PLAYWRIGHT_adminApiLoginUsername as string;
  static admin_api_login_password = process.env
    .PLAYWRIGHT_adminApiLoginPassword as string;
