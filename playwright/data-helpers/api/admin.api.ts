...
export default class AdminAPI {
  static admin_api_base_url = process.env.PLAYWRIGHT_adminApiUrl
  static adminLoginUrl = `${this.admin_api_base_url}/login/`
  static admin_api_login_user = process.env.PLAYWRIGHT_adminApiLoginUsername as string
  static admin_api_login_password = process.env.PLAYWRIGHT_adminApiLoginPassword as string
  ...
  static async createUserNote(noteTitle: string, noteText: string, user_id: number) {
    await this.setAdminAPIAccessToken()
    return (
      await axios({
        method: 'POST',
