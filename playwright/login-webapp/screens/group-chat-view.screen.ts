...
export class GroupChatViewScreen {
  ...
  static enterRoomNameButtonSelector = "[data-test='group-chat--enter-room-button']"
  ...
  static sendMessageButtonSelector = "[data-test='group-chat--send-message-button']"
  ...
  static messageWithUserSelector = (messageText: string, messageUser: string) => {
  ...
  messageWithUser: (messageText: string, messageUser: string) => InteractiveWebElement

  static leaveRoomButtonName = 'Leave Room Button'
  static leaveRoomButtonSelector = "[data-test='group-chat--leave-room-button']"
