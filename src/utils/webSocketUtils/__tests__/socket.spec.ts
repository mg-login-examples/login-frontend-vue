    ...
    it(
      ...
      async () => {
        ...
        eventEmitter.on("channelSubscriptionStatus", (subscriptionStatus) => {
          ...
          expect(subscriptionStatus.subscribed).toBe(
            subscribedPayload.subscribed
          );
    ...
    it(
      ...
      async () => {
        ...
        eventEmitter.on("channelMessage", (channelMessage) => {
          ...
          expect((channelMessage.message as any).data).toBe(
            channelMessagePayload.message.data
          );
    ...
    it(
      ...
      async () => {
        ...
        eventEmitter.on("otherMessage", (otherMessage) => {
          expect(JSON.stringify(otherMessage)).toBe(
            JSON.stringify(otherMessagePayload)
          );
