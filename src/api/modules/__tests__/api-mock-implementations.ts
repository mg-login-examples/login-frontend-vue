...
// User API
export const mockAxiosLoginUser = () => Promise.resolve({ data: fakeLoginResponse })

export const mockAxiosAuthenticateUser = () => Promise.resolve({ data: fakeUser })

export const mockAxiosLogoutUser = () => Promise.resolve(null)

export const mockAxiosCreateUser = () => Promise.resolve({ data: fakeLoginResponse })
...
export const mockAxiosGetUserQuotes = () => Promise.resolve({ data: fakeUserQuotes })

export const mockAxiosPostUserQuote = () => Promise.resolve({ data: fakeQuote })
...
// User notes
export const mockAxiosGetUserNotes = () => Promise.resolve({ data: fakeUserNotes })

export const mockAxiosPostUserNote = () => Promise.resolve({ data: fakeUserNote })
