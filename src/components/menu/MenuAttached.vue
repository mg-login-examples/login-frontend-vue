...
function onClickOutsideMenu() {
  const closeMenuWhenClickOutside = props.closeWhenClickOutside
    ? props.closeWhenClickOutside
    : true;
...
const menuPositionStyle = computed(() => {
  if (menuControl.value) {
    ...
    const menuControlWidth = (menuControl as Ref<HTMLElement>).value
      .clientWidth;
    const menuControlHeight = (menuControl as Ref<HTMLElement>).value
      .clientHeight;
    let menuTop = "";
    let menuRight = "";
    let menuBottom = "";
